...
export default function AddOnModal({
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
        ...
        <Button type="submit" disabled={saving} className="rounded-xl px-6 bg-[#221812] text-white hover:bg-black inline-flex items-center gap-2">
          ...
          {saving ? 'Saving...' : isEditing ? 'Update Add-on' : 'Save'}
        </Button>
      </div>
    </form>
  );
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl w-full max-w-lg p-6 sm:p-8 shadow-2xl relative border border-gray-100 max-h-[90vh] overflow-y-auto modal-scroll">
